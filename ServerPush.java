...
public class ServerPush {
        ...
        try {
            if (args.length == 1) {
                if (args[0].equals("h")) {
                    ...
                    System.out.println(
                            "Or please enter a -g to get a file from a computer, where it is on that computer, "
    ...
    public static void sendFile(String internalLocation, String externalLocation) throws Exception {
        ...
        output.println("asdfgh");
        output.flush();
        output.println("recieveFile");
        output.flush();
        output.println(externalLocation);
        output.flush();
